    ...
    <div class="guidepara-style mt30">
        <div class="guideBox-color">
            ...
            <h4>
                Now, go to
                <strong>
                    php-sdk/src/MSMoney/Rest/Connection.php,
                </strong>
                then change
                <strong>
                    BASE_URL
...
<pre style="display:block;">
    ...
    <span style="color:#707070;">//if you want to change the namespace/path from 'MSMoney' - lines[1-5] - to your desired name,
    i.e. (use MSMoney\Api\Amount; to use MyDomain\Api\Amount;), then you must change the folders name that holds
    the API classes as well as change the property 'MSMoney' in (autoload->psr-0) of (php-sdk/composer.json) file to your
    desired name and run "composer dump-autoload" command from sdk root</span>

    <span style="color:#cf1ffb;">use</span> MSMoney\Api\Payer;
    <span style="color:#cf1ffb;">use</span> MSMoney\Api\Amount;
    <span style="color:#cf1ffb;">use </span>MSMoney\Api\Transaction;
    <span style="color:#cf1ffb;">use</span> MSMoney\Api\RedirectUrls;
    <span style="color:#cf1ffb;">use</span> MSMoney\Api\Payment;

    <span style="color:#707070;">//Payer Object</span>
    <span style="color:#fd8f00;">$payer</span> = <span style="color:#cf1ffb;">new</span> Payer();
    <span style="color:#fd8f00;">$payer</span>->setPaymentMethod(<span style="color:#55bb17;">'MSMoney'</span>); <span style="color:#707070;">//preferably, your system name, example - MSMoney</span>
    ...
    example - http://saraf.tk/MSMoney_sdk/example-success.php</span>
    ...
    cancellation of payment, example -  http://saraf.tk/MSMoney_sdk/</span>
